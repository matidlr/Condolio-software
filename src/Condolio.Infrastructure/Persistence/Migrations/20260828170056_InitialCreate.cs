        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Moneda = table.Column<string>(type: "varchar(3)", maxLength: 3, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Activo = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CargoBaseMensual = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CreadoUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ActualizadoUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CuotaMantenimiento = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Coeficiente = table.Column<decimal>(type: "decimal(9,6)", precision: 9, scale: 6, nullable: true),
                    Facturable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreadoUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ActualizadoUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesdeUnidad = table.Column<int>(type: "int", nullable: false),
                    HastaUnidad = table.Column<int>(type: "int", nullable: true),
                    PrecioPorUnidad = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    CreadoUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ActualizadoUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanTramos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlanTramos_Planes_PlanId",
                        column: x => x.PlanId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrialInicioUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    TrialFinUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ProximoCobroUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    UnidadesFacturadas = table.Column<int>(type: "int", nullable: false),
                    ImporteMensual = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    PlanId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ProveedorSuscripcionId = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreadoUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ActualizadoUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Suscripciones_Administradores_AdministradorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnidadPersonas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnidadPersonas_Unidades_UnidadId",
                        column: x => x.UnidadId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consorcios_AdministradorId",
                table: "Consorcios",
                column: "AdministradorId");

            migrationBuilder.CreateIndex(
                name: "IX_PlanTramos_PlanId",
                table: "PlanTramos",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_Suscripciones_AdministradorId",
                table: "Suscripciones",
                column: "AdministradorId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Unidades_AdministradorId_ConsorcioId",
                table: "Unidades",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnidadPersonas_AdministradorId_UnidadId",
                table: "UnidadPersonas",
                columns: new[] { "AdministradorId", "UnidadId" });

            migrationBuilder.CreateIndex(
                name: "IX_UnidadPersonas_UnidadId",
                table: "UnidadPersonas",
                column: "UnidadId");
        }
