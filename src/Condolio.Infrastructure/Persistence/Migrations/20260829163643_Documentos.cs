        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarpetaPadreId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdministradorId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ConsorcioId = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    CarpetaId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    ...
                    SubidoPorUsuarioId = table.Column<string>(type: "varchar(450)", maxLength: 450, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SubidoPorNombre = table.Column<string>(type: "varchar(200)", maxLength: 200, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreadoUtc = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ActualizadoUtc = table.Column<DateTime>(type: "datetime(6)", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarpetasDocumento_AdministradorId_ConsorcioId_CarpetaPadreId",
                table: "CarpetasDocumento",
                columns: new[] { "AdministradorId", "ConsorcioId", "CarpetaPadreId" });

            migrationBuilder.CreateIndex(
                name: "IX_Documentos_AdministradorId_ConsorcioId_CarpetaId",
                table: "Documentos",
                columns: new[] { "AdministradorId", "ConsorcioId", "CarpetaId" });
        }
